      ...
      <div class="col-lg-4">
        <div class="card mb-4">
          <div class="card-body text-center">
            <img src="src/profile_pics/user.webp" alt="avatar" class="rounded-circle img-fluid" style="width: 150px;">
            ...
            <div class="d-flex justify-content-center mb-2">
              ...
              <button class="btn btn-danger btn-lg ms-1" onclick="location.href='index.php?module=delete&id=<?php echo $user['id']; ?>'">Delete</button>
